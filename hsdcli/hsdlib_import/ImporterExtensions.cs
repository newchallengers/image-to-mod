    ...
    public static class ImporterExtensions
    {
        ...
        public static void Meleeify(this IOBone root)
        {
            ...
            while (queue.Count > 0)
            {
                ...
                {
                    // NumericsExtensions.LookAtZ lives in HSDRawViewer.Extensions.NumericsExtensions
                    // which we don't include (rendering-adjacent). Falls back to identity for now.
